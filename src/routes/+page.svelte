...
<div id="app" x-data="app" class="flex flex-col items-center h-screen justify-start">
	...
	<div class="h-full max-w-[1000px] w-full flex flex-col flex-grow">
		<div class="flex flex-col items-center border-[1px] rounded-md border-neutral-700 sm:ml-8 ml-4 mr-4 sm:mr-8 h-full sm:pt-6 sm:pb-6 sm:pl-2 sm:pr-2 flex-grow">
			<!-- <div class="w-full flex  flex-col gap-2 items-center pl-16 pr-16 justify-center">
				<h2 class="text-white font-semibold text-3xl">Hello!</h2>
				<h3 class="text-neutral-500 font-normal text-sm italic">Please select an area</h3>
			</div> -->
			<div class="flex flex-col gap-4 w-full h-full sm:mt-6 mt-4 sm:pl-8 sm:pr-8 pl-2 pr-4 flex-grow">
				<HomeButton clickRoute="logs" buttonName="Logs" imgTitle="Onderwijsgek at nl.wikipedia, CC BY-SA 3.0 NL &lt;https://creativecommons.org/licenses/by-sa/3.0/nl/deed.en&gt;, via Wikimedia Commons" imgTitle2="NAC, CC BY-SA 3.0 https://creativecommons.org/licenses/by-sa/3.0, via Wikimedia Commons" imgSrc="https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/FFS_RABe_522_205_Basel_SBB_180611.jpg/512px-FFS_RABe_522_205_Basel_SBB_180611.jpg?20140315211945" imgHref="https://commons.wikimedia.org/wiki/File:FFS_RABe_522_205_Basel_SBB_180611.jpg" />
				<HomeButton clickRoute="overview" buttonName="Overview" imgTitle="NAC, CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons" imgTitle2="Onderwijsgek at nl.wikipedia, CC BY-SA 3.0 NL https://creativecommons.org/licenses/by-sa/3.0/nl/deed.en, via Wikimedia Commons" imgSrc="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Nederlandse_Spoorwegen_Kaartautomaat.jpg/512px-Nederlandse_Spoorwegen_Kaartautomaat.jpg?20110727140955" imgHref="https://commons.wikimedia.org/wiki/File:Nederlandse_Spoorwegen_Kaartautomaat.jpg" />
				...
				<HomeButton clickRoute="settings" buttonName="Settings" imgTitle="Onderwijsgek at nl.wikipedia, CC BY-SA 3.0 NL &lt;https://creativecommons.org/licenses/by-sa/3.0/nl/deed.en&gt;, via Wikimedia Commons" imgTitle2="Onderwijsgek at nl.wikipedia, CC BY-SA 3.0 NL https://creativecommons.org/licenses/by-sa/3.0/nl/deed.en, via Wikimedia Commons" imgSrc="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Nederlandse_Spoorwegen_Kaartautomaat.jpg/512px-Nederlandse_Spoorwegen_Kaartautomaat.jpg?20110727140955" imgHref="https://commons.wikimedia.org/wiki/File:Nederlandse_Spoorwegen_Kaartautomaat.jpg" />
			</div>
		</div>
	</div>
	{/if}
